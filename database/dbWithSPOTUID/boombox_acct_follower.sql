...
--
-- Dumping data for table `acct_follower`
--

LOCK TABLES `acct_follower` WRITE;
/*!40000 ALTER TABLE `acct_follower` DISABLE KEYS */;
/*!40000 ALTER TABLE `acct_follower` ENABLE KEYS */;
UNLOCK TABLES;
